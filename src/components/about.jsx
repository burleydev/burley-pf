      ...
      <div className='description bg-white p-8 col-span-3 flex items-center'>
        <div className='w-full'>
          {[
            ...
            <p key={idx} className='text-black hyphens-auto my-6 mx-5 leading-6 lg:text-xl md:text-3xl xs:text-lg'>{text}</p>
          ))}
          <div className='flex justify-center mt-6 lg:justify-end lg:mr-6'>
            <button className='lg:mr-2 md:p-5 md:my-6 xs:p-4'>
              <a href='./assets/docs/carlos-borrega_frontend-developer_resume.pdf' download='carlos-borrega_frontend-developer_resume' className='lg:text-md md:text-3xl md:p-8 xs:text-xl'>
                Download my CV
              </a>
            </button>
          </div>
