    ...
    return (
        <div className='grid grid-cols-5 place-items-center mx-[4rem] h-screen'>
            <div className='col-span-2'>
                <img src={Profile} alt="Carlos Borrega" className='rounded-l-lg'/>
            </div>
            <div className='bg-white col-span-3 p-8 h-[34rem] rounded-r-lg'>
                <p className='text-black my-6 text-sm leading-6'>Hello, I'm Carlos. I am a front-end developer specialising in JavaScript, driven by a passion for
